...
namespace PixARK_Tools
{
    internal static class Program
    {
        ...
        /// </summary>
        internal static readonly string Texto_Fecha = "2019_11_02_23_19_30_340"; // 2019_10_07_09_47_43_204.
        /// <summary>
        /// The maximum PixARK version that this tool was tested with (if I looked it right). Others might not work at all.
        /// </summary>
        internal static readonly string Texto_PixARK_Versión = "1.70";
        ...
        /// <summary>
        /// The date this tool was first created.
        /// </summary>
        internal static readonly string Texto_Fecha_Creación = "2019_10_07_09_47_43_204";
        ...
        /// <summary>
        /// Array that stores 16 gray scale colors including black and white at the ends, and increasing 17 tones each time.
        /// </summary>
        internal static Color[] Matriz_16_Colores_Grises_256 = null;
        /// <summary>
        ...
        /// <summary>
        /// Generates a 16 x 16 image with the desired byte colored.
        /// </summary>
        /// <param name="Valor">Any byte from 0 to 255.</param>
        /// <returns>Returns a new image with the byte drawed on it. Returns null on any error.</returns>
        internal static Bitmap Obtener_Imagen_Byte_2D(int Valor)
        {
            try
            {
                Bitmap Imagen = new Bitmap(16, 16, PixelFormat.Format24bppRgb);
                Graphics Pintar = Graphics.FromImage(Imagen);
                Pintar.CompositingMode = CompositingMode.SourceCopy; // Draw over the map.
                Pintar.CompositingQuality = CompositingQuality.HighQuality;
                ...
                Pintar.FillRectangle(Brushes.White, Valor % 16, Valor / 16, 1, 1);
                Pintar.Dispose();
                Pintar = null;
                return Imagen;
            }
        ...
        internal static string Traducir_Lista_Variables(List<long> Lista_Objetos)
        {
            try
            {
                if (Lista_Objetos != null && Lista_Objetos.Count > 0)
                {
                    string Texto = null;
                    foreach (long Valor in Lista_Objetos)
                    {
                        try { Texto += Valor.ToString() + ", "; }
                        catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); continue; }
                    }
        ...
        internal static string Traducir_Lista_Variables(long[] Matriz_Objetos)
        {
            try
            {
                if (Matriz_Objetos != null && Matriz_Objetos.Length > 0)
                {
                    string Texto = null;
                    foreach (long Valor in Matriz_Objetos)
                    {
                        try { Texto += Valor.ToString() + ", "; }
                        catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); continue; }
                    }
        ...
        static void Main(string[] Matriz_Argumentos)
        {
            ...
            PixARK_Seeds.Buscar_Semillas_Parecidas();
            /*for (int Índice_Byte = 0; Índice_Byte < 256; Índice_Byte++)
            {
                PixARK_Seeds.Lista_Semilas_Parecidas[Índice_Byte] = new KeyValuePair<byte, List<int>>((byte)Índice_Byte, new List<int>());
            }*/
            Matriz_16_Colores_Arco_Iris_256 = new Color[256];
            Matriz_16_Colores_Grises_256 = new Color[256];
            ...
            for (int Índice = 0; Índice < 256; Índice++)
            {
                ...
                Matriz_16_Colores_Grises_256[Índice] = Color.FromArgb(255, (Índice % 16) * 17, (Índice % 16) * 17, (Índice % 16) * 17);
            ...
            PixARK_Ruins.Lista_Alturas_Ruinas.Add(PixARK_Ruins.Matriz_Alturas_Broken_Ruin);
            PixARK_Ruins.Lista_Alturas_Ruinas.Add(PixARK_Ruins.Matriz_Alturas_Death_Lord_Platform);
            PixARK_Ruins.Lista_Alturas_Ruinas.Add(PixARK_Ruins.Matriz_Alturas_Ice_Ruin);
            PixARK_Ruins.Lista_Alturas_Ruinas.Add(PixARK_Ruins.Matriz_Alturas_Pyramid_Ruin);
            PixARK_Ruins.Lista_Alturas_Ruinas.Add(PixARK_Ruins.Matriz_Alturas_Relic_Ruin);
