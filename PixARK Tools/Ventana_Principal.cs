...
namespace PixARK_Tools
{
    public partial class Ventana_Principal : Form
    {
        ...
        /// <summary>
        /// The currently loaded world type. If it's zero it's the default PixARK biomes and if it's 1
        /// it's the new SkyARK DLC biomes. Use this index to access the biome array and get the proper
        /// biome colors.
        /// </summary>
        internal byte Tipo_Mundo = 0;
        /// <summary>
        ...
        internal static bool Variable_Generar_Mapas_Superficie = false;
        internal static bool Variable_Mostrar_Lista_Trucos = false;
        internal GroupBox[][] Matriz_Grupos = null;
        ...
        private void Ventana_Principal_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Matriz_Pictures = new PictureBox[2][]
                {
                    new PictureBox[22]
                    {
                        Picture_Leyenda_0,
                ...
                for (int Índice_Tipo = 0; Índice_Tipo < 2; Índice_Tipo++)
                {
                    for (int Índice = 0; Índice < Matriz_Pictures[Índice_Tipo].Length; Índice++)
                    {
                        foreach (PixARK.Biomas Bioma in PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Índice_Tipo])
                        {
                            if (Bioma.Orden == Índice)
                            {
                                Matriz_Pictures[Índice_Tipo][Índice].BackColor = Variable_Mostrar_Minerales ? Bioma.Color : Bioma.Color_Simple;
                                Matriz_Etiquetas[Índice_Tipo][Índice].ForeColor = Color.Black;
                                Matriz_Etiquetas[Índice_Tipo][Índice].Text = Bioma.Índice.ToString() + ": " + (Tipo_Mundo == 0 && string.Compare(Bioma.Nombre, Bioma.Nombre_Simple, true) != 0 ? Bioma.Nombre_Simple + (!Bioma.Nombre_Simple.EndsWith("s") ? "'s " : "' ") : null) + Bioma.Nombre + (Bioma.Minerales != PixARK.Minerales.Unknown ? " (" + Bioma.Minerales.ToString().Replace('_', ' ') + ")" : null) + ".";
                                break;
                            }
                        }
                    }
                ...
                Menú_Contextual_Generar_Mapas_Superficie.Checked = Variable_Generar_Mapas_Superficie;
        ...
        private void Ventana_Principal_Shown(object sender, EventArgs e)
        {
            try
            {
                //Calcular_Diferencias_Altura_Ruinas();
                this.Activate();
        ...
        private void ComboBox_Ruta_PixARK_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                Matriz_Grupos[Tipo_Mundo][0].Text = "Easy difficulty main biomes";
                Matriz_Grupos[Tipo_Mundo][1].Text = "Medium difficulty main biomes";
                Matriz_Grupos[Tipo_Mundo][2].Text = "Hard difficulty main biomes";
                Matriz_Grupos[Tipo_Mundo][3].Text = "Easy difficulty resources biomes";
                Matriz_Grupos[Tipo_Mundo][4].Text = "Medium difficulty resources biomes";
                Matriz_Grupos[Tipo_Mundo][5].Text = "Hard difficulty resources biomes";
                for (int Índice = 0; Índice < Matriz_Pictures[Tipo_Mundo].Length; Índice++)
                {
                    foreach (PixARK.Biomas Bioma in PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo])
                    {
                        if (Bioma.Orden == Índice)
                        {
                            Matriz_Pictures[Tipo_Mundo][Índice].BackColor = Variable_Mostrar_Minerales ? Bioma.Color : Bioma.Color_Simple;
                            Matriz_Etiquetas[Tipo_Mundo][Índice].ForeColor = Color.Black;
                            Matriz_Etiquetas[Tipo_Mundo][Índice].Text = Bioma.Índice.ToString() + ": " + (Tipo_Mundo == 0 && string.Compare(Bioma.Nombre, Bioma.Nombre_Simple, true) != 0 ? Bioma.Nombre_Simple + (!Bioma.Nombre_Simple.EndsWith("s") ? "'s " : "' ") : null) + Bioma.Nombre + (Bioma.Minerales != PixARK.Minerales.Unknown ? " (" + Bioma.Minerales.ToString().Replace('_', ' ') + ")" : null) + ".";
                            break;
                        }
                    }
                }
        ...
        private void Botón_Cargar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                bool Actualizar_Semillas_Parecidas = false;
                Semilla = 0;
                Imagen_Biomas_Original = null;
                Imagen_Biomas_Original_Simple = null;
                Imagen_Altura_Original = null;
                ...
                {
                    // Start with default values for all the fields and hope for the best.
                    ...
                    int Ancho = PixARK.Dimensiones_Mundo;
                    int Alto = PixARK.Dimensiones_Mundo;
                    Tipo_Mundo = 0; // PixARK world.
                    try
                    {
                                        ...
                                        while (!Lector_Texto.EndOfStream)
                                        {
                                            try
                                            {
                                                ...
                                                if (!string.IsNullOrEmpty(Línea))
                                                {
                                                    ...
                                                    else if (Línea.Contains("scenename")) // SceneName.
                                                    {
                                                        int Índice_Igual = Línea.IndexOf('=');
                                                        if (Índice_Igual > -1 && Índice_Igual + 1 < Línea.Length) // Has at least 1 extra character.
                                                        {
                                                            string Texto_Tipo_Mundo = Línea.Substring(Índice_Igual + 1);
                                                            if (!string.IsNullOrEmpty(Texto_Tipo_Mundo) &&
                                                                string.Compare(Texto_Tipo_Mundo, "SkyPiea_light", true) == 0) // "CubeWorld_Light", "SkyPiea_light".
                                                            {
                                                                Tipo_Mundo = 1; // We found the new SkyARK DLC biomes.
                                                            }
                                                            Texto_Tipo_Mundo = null;
                                                        }
                                                    }
                                                        ...
                                                        if (Índice_Igual > -1)
                                                        {
                                                            ...
                                                            if (Lista_Caracteres.Count > 0)
                                                            {
                                                                try
                                                                {
                                                                    ...
                                                                    Actualizar_Semillas_Parecidas = !PixARK_Seeds.Lista_Semilas_Parecidas[Valor].Value.Contains(Semilla);
                                                                    Barra_Estado_Etiqueta_Semilla.Text = "Seed: " + Program.Traducir_Número(Semilla) + " (byte " + Valor.ToString() + ", x" + (!Actualizar_Semillas_Parecidas ? PixARK_Seeds.Lista_Semilas_Parecidas[Valor].Value.Count.ToString() : (PixARK_Seeds.Lista_Semilas_Parecidas[Valor].Value.Count + 1).ToString()) + (!Actualizar_Semillas_Parecidas ? ")" : ", new)");
                                                                    Texto_Bits = null;
                                                                }
                                                                catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; Semilla = -1; }
                                                            }
                                                            Lista_Caracteres = null;
                                                        }
                                                    }
                    ...
                    if (File.Exists(Ruta_Terrain_DB))
                    {
                        ...
                        try
                        {
                            if (Variable_Generar_Mapas_Superficie)
                            {
                                    ...
                                    Set_Datos.Tables[0].Rows.Count > 0) // Valid table, columns and rows.
                                {
                                    ...
                                    if (Lista_Bytes_Altura.Count > 0)
                                    {
                                        ...
                                        Color Color_Arco_Iris;
                                        Color Color_Bioma;
                                        // First full pass to find and recolor any known ruin surface.
                                        /*for (int Índice_Y = 0, Índice = 0, Altura_Base = 0; Índice_Y < Alto; Índice_Y++, Índice += Bytes_Diferencia_Altura)
                                        {
                                            for (int Índice_X = 0; Índice_X < Ancho; Índice_X++, Índice += Bytes_Aumento_Altura)
                                            {
                                                if (Matriz_Bytes_ARGB_Altura[Índice + 3] > 0) // Not transparent, a possible ruins location.
                                                {
                                                    for (int Índice_Ruina = 0, Píxeles_Diferentes = 0; Índice_Ruina < PixARK_Ruins.Lista_Alturas_Ruinas.Count; Índice_Ruina++)
                                                    {
                                                        Altura_Base = Matriz_Bytes_ARGB_Altura[Índice] + PixARK_Ruins.Lista_Alturas_Ruinas[Índice_Ruina][0, 0];
                                                        //bool Estructura_Encontrada = true;
                                                        for (int Y = 0, Subíndice = 0; Y < PixARK_Ruins.Matriz_Dimensiones_Ruinas[Índice_Ruina].Height; Y++)
                                                        {
                                                            for (int X = 0; X < PixARK_Ruins.Matriz_Dimensiones_Ruinas[Índice_Ruina].Width; X++)
                                                            {
                                                                if (Índice_X + Y < Ancho && Índice_Y + X < Alto)
                                                                {
                                                                    Subíndice = (Bytes_Ancho_Altura * (Índice_Y + X)) + ((Índice_X + Y) * Bytes_Aumento_Altura);
                                                                    if (Matriz_Bytes_ARGB_Altura[Índice] - Altura_Base == PixARK_Ruins.Lista_Alturas_Ruinas[Índice_Ruina][X, Y])
                                                                    {
                                                                        Píxeles_Diferentes++;
                                                                        //Píxeles_Iguales++;
                                                                        //if (Píxeles_Iguales >= Píxeles_Límite) break;
                                                                        //Estructura_Encontrada = false;
                                                                        //break;
                                                                    }
                                                                    //else Píxeles_Diferentes++;
                                                                    if (Píxeles_Diferentes >= PixARK_Ruins.Matriz_Píxeles_Ruinas_16[Índice_Ruina]) break;
                                                                }
                                                            }
                                                            if (Píxeles_Diferentes >= PixARK_Ruins.Matriz_Píxeles_Ruinas_16[Índice_Ruina]) break;
                                                            //if (Píxeles_Iguales >= Píxeles_Límite) break;
                                                            //if (Píxeles_Diferentes >= Píxeles_Límite) break;
                                                            //if (!Estructura_Encontrada) break;
                                                        }
                                                        //if (Estructura_Encontrada) // We found a full ruins structure.
                                                        if (Píxeles_Diferentes >= PixARK_Ruins.Matriz_Píxeles_Ruinas_16[Índice_Ruina])
                                                        {
                                                            //MessageBox.Show(this, "Ruin found!");
                                                            for (int Y = 0, Subíndice = 0; Y < PixARK_Ruins.Matriz_Dimensiones_Ruinas[Índice_Ruina].Height; Y++)
                                                            {
                                                                for (int X = 0; X < PixARK_Ruins.Matriz_Dimensiones_Ruinas[Índice_Ruina].Width; X++)
                                                                {
                                                                    ...
                                                                    {
                                                                        Subíndice = (Bytes_Ancho_Altura * (Índice_Y + X)) + ((Índice_X + Y) * Bytes_Aumento_Altura);
                                                                        // Recolor the found ruin with 16 colors to easily see it in the map.
                                                                        Color_Arco_Iris = Program.Matriz_16_Colores_Arco_Iris_256[Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Altura[Subíndice]]];
                                                                        Matriz_Bytes_ARGB_Altura[Subíndice + 2] = Color_Arco_Iris.R;
                                                                        Matriz_Bytes_ARGB_Altura[Subíndice + 1] = Color_Arco_Iris.G;
                                                                        Matriz_Bytes_ARGB_Altura[Subíndice] = Color_Arco_Iris.B;
                                                                    }
                                                                }
                                                            }
                                                            break;
                                        ...
                                        // Second full pass to finish the recolor with partially mixed biome colors and rainbows.
                                        for (int Y = 0, Índice = 0, Índice_Byte_Bioma = Índice_Byte_Bioma_Inicio; Y < Alto; Y++, Índice += Bytes_Diferencia_Altura)
                                        {
                                            for (int X = 0; X < Ancho; X++, Índice += Bytes_Aumento_Altura, Índice_Byte_Bioma++)
                                            {
                                                if (Matriz_Bytes_ARGB_Altura[Índice + 3] > 0) // Not transparent.
                                                {
                                                    // Avoid recoloring any possible found ruin that is already colored.
                                                    //if (Matriz_Bytes_ARGB_Altura[Índice] == Matriz_Bytes_ARGB_Altura[Índice + 1] && Matriz_Bytes_ARGB_Altura[Índice] == Matriz_Bytes_ARGB_Altura[Índice + 2])
                                                    {
                                                        // Use 5 parts of the "normalized" height and 1 of the original biome colors.
                                                        Color_Bioma = Variable_Mostrar_Minerales ? PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte_Bioma]].Color : PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte_Bioma]].Color_Simple;
                                                        Matriz_Bytes_ARGB_Altura[Índice + 2] = (byte)(((Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Altura[Índice]] * 5) + Color_Bioma.R) / 6);
                                                        Matriz_Bytes_ARGB_Altura[Índice + 1] = (byte)(((Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Altura[Índice]] * 5) + Color_Bioma.G) / 6);
                                                        Matriz_Bytes_ARGB_Altura[Índice] = (byte)(((Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Altura[Índice]] * 5) + Color_Bioma.B) / 6);
                                                    }
                                                    // Recolor the rainbow image with 16 colors to easily see any ruin in it.
                                                    //Color_Arco_Iris = Program.Matriz_16_Colores_Grises_256[Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Arco_Iris[Índice]]]; // Monochrome rainbow?
                                                    Color_Arco_Iris = Program.Matriz_16_Colores_Arco_Iris_256[Matriz_Bytes_Normalización_Altura[Matriz_Bytes_ARGB_Arco_Iris[Índice]]];
                        ...
                        int Total_Media = 0;
                        int Total_Difícil = 0;
                        int Total_Agua_Vacío = 0;
                        int Total_Minerales = 0;
                        int Total_Cobre = 0; // Copper is always on easy biomes.
                        int Total_Hierro = 0; // Iron is found on all biome difficulties.
                        int Total_Hierro_Fácil = 0;
                        int Total_Hierro_Medio = 0;
                        int Total_Hierro_Difícil = 0;
                        int Total_Plata = 0; // Silver is always on hard biomes.
                        int Total_Oro = 0; // Gold is always on hard biomes.
                        if (Variable_Ocultar_Bordes)
                        {
                            if (Tipo_Mundo == 0) // PixARK.
                            {
                                ...
                                for (int Y = 0, Índice_Byte = Índice_Byte_Bioma_Inicio; Y < Alto; Y++)
                                {
                                    for (int X = 0; X < Ancho; X++, Índice_Byte++)
                                    {
                                        if (Índice_Byte < Matriz_Bytes_Biomas.Length &&
                                            Matriz_Bytes_Biomas[Índice_Byte] < PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo].Length &&
                                            ...
                                            Y < Alto - PixARK.Borde_Mundo)
                                        {
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Dificultad == PixARK.Dificultades.Easy) Total_Fácil++;
                                            else if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Dificultad == PixARK.Dificultades.Medium) Total_Media++;
                                            else if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Dificultad == PixARK.Dificultades.Hard) Total_Difícil++;

                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 0 ||
                                                //PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes[Índice_Byte]].Índice == 11 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 13) Total_Agua_Vacío++;

                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 15 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 18)
                                            {
                                                Total_Minerales++;
                                                Total_Cobre++;
                                            }

                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 17)
                                            {
                                                Total_Minerales++;
                                                Total_Hierro++;
                                                Total_Hierro_Fácil++;
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 14 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 16 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 21)
                                            {
                                                Total_Minerales++;
                                                Total_Hierro++;
                                                Total_Hierro_Medio++;
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 20 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 22)
                                            {
                                                Total_Minerales++;
                                                Total_Hierro++;
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 23)
                                            {
                                                Total_Minerales++;
                                                Total_Plata++;
                                            }
                                ...
                                for (int Y = 0, Índice_Byte = Índice_Byte_Bioma_Inicio; Y < Alto; Y++)
                                {
                                    for (int X = 0; X < Ancho; X++, Índice_Byte++)
                                    {
                                            ...
                                            Y < Alto - PixARK.Borde_Mundo)
                                        {
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 0) Total_Agua_Vacío++;

                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 10 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 13)
                                            {
                                                Total_Minerales++;
                                                Total_Cobre++;
                                            }
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 10)
                                            {
                                                //Total_Minerales++; // Avoid repeating this double ore types biome.
                                                Total_Hierro++;
                                                Total_Hierro_Fácil++;
                                            }

                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 11 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 12)
                                            {
                                                Total_Minerales++;
                                                Total_Hierro++;
                                                Total_Hierro_Medio++;
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 9 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 15)
                                            {
                                                Total_Minerales++;
                                                Total_Hierro++;
                                                Total_Hierro_Difícil++;
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 8)
                                            {
                                                Total_Minerales++;
                                                Total_Plata++;
                                            }
                                            ...
                                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 17 ||
                                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Índice == 19)
                                            {
                                                Total_Minerales++;
                                                Total_Oro++;
                                            }
                        ...
                        if (Tipo_Mundo == 0) // PixARK.
                        {
                            Matriz_Grupos[Tipo_Mundo][0].Text = "Easy difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[10] + Matriz_Biomas[2] + Matriz_Biomas[5] + Matriz_Biomas[8] + Matriz_Biomas[13]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][1].Text = "Medium difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[0] + Matriz_Biomas[1] + Matriz_Biomas[4] + Matriz_Biomas[7]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][2].Text = "Hard difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[9] + Matriz_Biomas[6] + Matriz_Biomas[3]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][3].Text = "Easy difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[15] + Matriz_Biomas[17] + Matriz_Biomas[18] + Matriz_Biomas[11]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][4].Text = "Medium difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[21] + Matriz_Biomas[16] + Matriz_Biomas[14]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][5].Text = "Hard difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[20] + Matriz_Biomas[22] + Matriz_Biomas[23]) * 100d) / (double)Total_Biomas, 4) + " %]";
                        }
                        else // SkyARK.
                        {
                            Matriz_Grupos[Tipo_Mundo][0].Text = "Easy difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[0] + Matriz_Biomas[1] + Matriz_Biomas[4] + Matriz_Biomas[5]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][1].Text = "Medium difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[6] + Matriz_Biomas[7]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][2].Text = "Hard difficulty main biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[2] + Matriz_Biomas[3] + Matriz_Biomas[14] + Matriz_Biomas[16] + Matriz_Biomas[18]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][3].Text = "Easy difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[10] + Matriz_Biomas[13]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][4].Text = "Medium difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[11] + Matriz_Biomas[12]) * 100d) / (double)Total_Biomas, 4) + " %]";
                            Matriz_Grupos[Tipo_Mundo][5].Text = "Hard difficulty resources biomes - [" + Program.Traducir_Número_Decimales_Redondear(((double)(Matriz_Biomas[8] + Matriz_Biomas[9] + Matriz_Biomas[15] + Matriz_Biomas[17] + Matriz_Biomas[19]) * 100d) / (double)Total_Biomas, 4) + " %]";
                        }
                        for (int Índice_Tipo = 0; Índice_Tipo < 2; Índice_Tipo++)
                        {
                            for (int Índice = 0; Índice < Matriz_Grupos[Índice_Tipo].Length; Índice++)
                            {
                                Matriz_Grupos[Índice_Tipo][Índice].Enabled = Índice_Tipo == Tipo_Mundo;
                                Matriz_Grupos[Índice_Tipo][Índice].Visible = Índice_Tipo == Tipo_Mundo;
                            }
                        }
                        for (int Índice = 0; Índice < Matriz_Pictures[Tipo_Mundo].Length; Índice++)
                        {
                            foreach (PixARK.Biomas Bioma in PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo])
                            {
                                ...
                                {
                                    Matriz_Pictures[Tipo_Mundo][Índice].BackColor = Variable_Mostrar_Minerales ? Bioma.Color : Bioma.Color_Simple;
                                    Matriz_Etiquetas[Tipo_Mundo][Índice].ForeColor = Tipo_Mundo == 0 ? (Matriz_Biomas[Bioma.Índice] > 0 ? (Matriz_Biomas[Bioma.Índice] >= Matriz_Porcentajes[8] ? Color.Blue : Color.Black) : Color.Red) : (Matriz_Biomas[Bioma.Índice] > 0 ? (Matriz_Biomas[Bioma.Índice] >= Matriz_Porcentajes[4] ? Color.Blue : Color.Black) : Color.Red);
                                    Matriz_Etiquetas[Tipo_Mundo][Índice].Text = Bioma.Índice.ToString() + ": " + (Tipo_Mundo == 0 && string.Compare(Bioma.Nombre, Bioma.Nombre_Simple, true) != 0 ? Bioma.Nombre_Simple + (!Bioma.Nombre_Simple.EndsWith("s") ? "'s " : "' ") : null) + Bioma.Nombre + (Bioma.Minerales != PixARK.Minerales.Unknown ? " (" + Bioma.Minerales.ToString().Replace('_', ' ') + ")" : null) + " [" + Program.Traducir_Número_Decimales_Redondear(((double)Matriz_Biomas[Bioma.Índice] * 100d) / (double)Total_Biomas, 4) + " %].";
                                    break;
                                }
                            }
                        }
                        // Adjust the vertical location and height of the world analysis text box.
                        if (Tipo_Mundo == 0)
                        {
                            int Y = (Grupo_Recursos_Difíciles.Location.Y + Grupo_Recursos_Difíciles.Height) + 6;
                            if (TextBox_Análisis.Location.Y != Y)
                            {
                                int Diferencia = Math.Abs(TextBox_Análisis.Location.Y - Y);
                                TextBox_Análisis.Location = new Point(TextBox_Análisis.Location.X, Y);
                                TextBox_Análisis.Height -= Diferencia;
                            }
                        }
                        else
                        {
                            int Y = (Grupo_SkyARK_Recursos_Difíciles.Location.Y + Grupo_SkyARK_Recursos_Difíciles.Height) + 6;
                            if (TextBox_Análisis.Location.Y != Y)
                            {
                                int Diferencia = Math.Abs(TextBox_Análisis.Location.Y - Y);
                                TextBox_Análisis.Location = new Point(TextBox_Análisis.Location.X, Y);
                        ...
                        for (int Índice = 0; Índice < PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo].Length; Índice++)
                        {
                            if (Tipo_Mundo == 0) // PixARK.
                            {
                                if (!PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice].Bioma_Minerales)
                                {
                            ...
                            else // SkyARK.
                            {
                                ...
                                {
                                    if (Matriz_Biomas[Índice] < Mínimo_Total &&
                                    Índice != 0 && // Ignore the biomes 0 (Void Lands) and 4 (Dawn Island).
                                    Índice != 4) // Minimum biome found.
                                    {
                                        Mínimo_Índice = Índice;
                                        Mínimo_Total = Matriz_Biomas[Índice];
                                    }
                                    if (Matriz_Biomas[Índice] > 0 &&
                                        Matriz_Biomas[Índice] < Mínimo_Cero_Total &&
                                        Índice != 0 && // Ignore the biomes 0 (Void Lands) and 4 (Dawn Island).
                                        Índice != 4) // Minimum existing biome found.
                                    {
                                        Mínimo_Cero_Índice = Índice;
                                        Mínimo_Cero_Total = Matriz_Biomas[Índice];
                                    }
                                    if (Matriz_Biomas[Índice] > Máximo_Total &&
                                        Índice != 0 && // Ignore the biomes 0 (Void Lands) and 4 (Dawn Island).
                                        Índice != 4) // Maximum biome found.
                                    {
                                        Máximo_Índice = Índice;
                                        Máximo_Total = Matriz_Biomas[Índice];
                                    }
                        ...
                        string Texto_Análisis = "The seed " + Program.Traducir_Número(Semilla) + (Tipo_Mundo == 1 ? " for the SkyARK DLC" : null) + " has ";
                        ...
                        if (Tipo_Mundo == 0) // PixARK.
                        {
                            ...
                            {
                                Texto_Análisis += "with mostly " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Máximo_Índice].Nombre.ToLowerInvariant() + " ";
                            }
                            else
                            {
                                Texto_Análisis += "with lots of " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Máximo_Índice].Nombre.ToLowerInvariant() + " ";
                            }

                            // Add the less common biomes in the world.
                            if (Mínimo_Total > 0)
                            {
                                Texto_Análisis += "and very few " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Mínimo_Índice].Nombre.ToLowerInvariant() + ", ";
                            }
                            else
                            {
                                ...
                                for (int Índice = 0; Índice < 14/*PixARK.Biomas.Matriz_Biomas.Length*/; Índice++)
                                {
                                    ...
                                    {
                                        Lista_Biomas_Inexistentes.Add(PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice].Nombre.ToLowerInvariant());
                                    }
                                }
                                ...
                                {
                                    Texto_Análisis += "and nothing of " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Mínimo_Índice].Nombre.ToLowerInvariant() + ", ";
                                }
                            }
                            ...
                            if (Total_Agua_Vacío >= Matriz_Porcentajes[25])
                            {
                                Texto_Análisis += ", perfect to navigate using boats";
                            }
                            else if (Total_Agua_Vacío >= Matriz_Porcentajes[20])
                            {
                                Texto_Análisis += ", useful to navigate using boats";
                            }
                            else if (Total_Agua_Vacío <= 0) // Dry world.
                            {
                                Texto_Análisis += ", doesn't has any water to navigate";
                            }
                            else if (Total_Agua_Vacío <= Matriz_Porcentajes[5])
                            {
                                Texto_Análisis += ", doesn't has enough water to navigate";
                            }
                            else if (Total_Agua_Vacío <= Matriz_Porcentajes[10])
                            {
                                Texto_Análisis += ", doesn't has much water to navigate";
                            }
                        ...
                        {
                            // Add the biome count.
                            if (Lista_Biomas.Count >= 20) Texto_Análisis += "all biomes, ";
                            else if (Lista_Biomas.Count >= 18) Texto_Análisis += "almost all biomes, ";
                            else if (Lista_Biomas.Count >= 16) Texto_Análisis += "several biomes missing, ";
                            else if (Lista_Biomas.Count >= 14) Texto_Análisis += "lots of biomes missing, ";
                            else Texto_Análisis += "too many biomes missing, ";

                            if (Diferencia_Máximo_Mínimo < Matriz_Porcentajes[5])
                            {
                                Texto_Análisis += "perfectly balanced, ";
                            }
                            else if (Diferencia_Máximo_Mínimo < Matriz_Porcentajes[10])
                            {
                                Texto_Análisis += "very well balanced, ";
                            }
                            else if (Diferencia_Máximo_Mínimo < Matriz_Porcentajes[15])
                            ...
                            else
                            {
                                ...
                                for (int Índice = 0; Índice < 14/*PixARK.Biomas.Matriz_Biomas.Length*/; Índice++)
                                {
                                    if (Índice != 4 && // Again ignore the biome 4 or "Dawn Island".
                                        Matriz_Biomas[Índice] <= 0)
                                    {
                                        Lista_Biomas_Inexistentes.Add(PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice].Nombre.ToLowerInvariant());
                                    }
                            ...
                            // Add the void to see if it's useful for flying over the void.
                            if (Total_Agua_Vacío >= Matriz_Porcentajes[50])
                            {
                                Texto_Análisis += ", has too much void";
                            }
                            else if (Total_Agua_Vacío >= Matriz_Porcentajes[40])
                            {
                                Texto_Análisis += ", has an average void";
                            }
                            else if (Total_Agua_Vacío <= 0) // Solid world.
                            {
                                Texto_Análisis += ", doesn't has any void";
                            }
                            else if (Total_Agua_Vacío <= Matriz_Porcentajes[20])
                            {
                                Texto_Análisis += ", has very few void";
                            }
                            else if (Total_Agua_Vacío <= Matriz_Porcentajes[30])
                            {
                                Texto_Análisis += ", has less void";
                            }

                            // Add the more common surface metal ores.
                            if (Total_Oro >= Total_Plata && Total_Oro >= Total_Cobre && Total_Oro >= Total_Hierro)
                            {
                                Texto_Análisis += " and it should have hard to get gold ores exposed on the surface among other resources";
                            }
                            else if (Total_Plata >= Total_Oro && Total_Plata >= Total_Cobre && Total_Plata >= Total_Hierro)
                            {
                                Texto_Análisis += " and it should have hard to get silver ores exposed on the surface among other resources";
                            }
                            else if (Total_Cobre >= Total_Oro && Total_Cobre >= Total_Plata && Total_Cobre >= Total_Hierro)
                            {
                                Texto_Análisis += " and it should have easy to get copper ores exposed on the surface among other resources";
                            }
                            else
                        ...
                        {
                            List<byte> Lista_Biomas_Desconocidos = new List<byte>();
                            foreach (byte Índice_Bioma in Lista_Biomas)
                            {
                                try
                                {
                                    ...
                                    foreach (PixARK.Biomas Bioma in PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo])
                                    {
                                        if (Bioma.Índice == Índice_Bioma &&
                                            !string.IsNullOrEmpty(Bioma.Nombre) &&
                                            Bioma.Nombre != "?")
                                        {
                                            Desconocido = false;
                                            break;
                                    ...
                                    if (Desconocido && !Lista_Biomas_Desconocidos.Contains(Índice_Bioma))
                                    {
                                        Lista_Biomas_Desconocidos.Add(Índice_Bioma);
                                    }
                                }
                                catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; }
                            }
                            if (Lista_Biomas_Desconocidos.Count > 0)
                            {
                                if (Lista_Biomas_Desconocidos.Count > 1) Lista_Biomas_Desconocidos.Sort();
                                MessageBox.Show(this, Program.Traducir_Número(Lista_Biomas_Desconocidos.Count) + (Lista_Biomas_Desconocidos.Count != 1 ? " unknown biomes found: " : " unknown biome found: ") + Program.Traducir_Lista_Variables(Lista_Biomas_Desconocidos) + ".", Program.Texto_Título_Versión, MessageBoxButtons.OK, MessageBoxIcon.Information);
                            }
                            Lista_Biomas_Desconocidos = null;
                        }
                        ...
                        for (int Y = 0, Índice = 0, Índice_Byte = Índice_Byte_Bioma_Inicio; Y < Alto; Y++, Índice += Bytes_Diferencia)
                        {
                            for (int X = 0; X < Ancho; X++, Índice += Bytes_Aumento, Índice_Byte++)
                            {
                                    ...
                                    Matriz_Bytes_Biomas[Índice_Byte] < PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo].Length)
                                {
                                    ...
                                    Matriz_Bytes_ARGB[Índice + 2] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color.R;
                                    Matriz_Bytes_ARGB[Índice + 1] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color.G;
                                    Matriz_Bytes_ARGB[Índice] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color.B;

                                    // Main biome map without ores and resources (the one PixARK shows).
                                    Matriz_Bytes_ARGB_Simple[Índice + 3] = 255;
                                    Matriz_Bytes_ARGB_Simple[Índice + 2] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color_Simple.R;
                                    Matriz_Bytes_ARGB_Simple[Índice + 1] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color_Simple.G;
                                    Matriz_Bytes_ARGB_Simple[Índice] = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Matriz_Bytes_Biomas[Índice_Byte]].Color_Simple.B;
                                }
                        ...
                        // Debug test only for Jupisoft that saves all the original generated maps at 5.120 x 5.120.
                        if (string.Compare(Environment.UserName, "Jupisoft", true) == 0)
                        {
                            string Ruta_Mapas_Imágenes = Environment.GetFolderPath(Environment.SpecialFolder.MyPictures) + "\\PixARK Seeds";
                            Program.Crear_Carpetas(Ruta_Mapas_Imágenes);
                            string Texto_Semilla = Semilla.ToString();
                            /*while (File.Exists(Ruta_Mapas_Imágenes + "\\" + Texto_Semilla + ".png")) // Repeat the seeds?
                            {
                                Texto_Semilla = '_' + Texto_Semilla;
                            }*/
                            if (!File.Exists(Ruta_Mapas_Imágenes))
                            {
                                Imagen_Biomas_Original.Save(Ruta_Mapas_Imágenes + "\\" + Texto_Semilla + ".png", ImageFormat.Png);
                            }
                            Texto_Semilla = null;
                            Ruta_Mapas_Imágenes = null;
                        }
                        // And always save a 320 x 320 thumbnail of each unique map to compare the seeds later on.
                        // This thumbnail is exactly 16 times smaller, so 1 chunk now equals 1 pixel.
                        Bitmap Imagen_320 = Program.Obtener_Imagen_Miniatura(Imagen_Biomas_Original, 320, 320, true, false, CheckState.Unchecked);
                        if (Imagen_320 != null)
                        {
                            string Ruta_Mapas_Jupisoft = Application.StartupPath + "\\Seeds";
                            Program.Crear_Carpetas(Ruta_Mapas_Jupisoft);
                            string Texto_Semilla = Semilla.ToString();
                            /*while (File.Exists(Ruta_Mapas_Jupisoft + "\\" + Texto_Semilla + ".png")) // Repeat the seeds?
                            {
                                Texto_Semilla = '_' + Texto_Semilla;
                            }*/
                            if (!File.Exists(Ruta_Mapas_Jupisoft + "\\" + Texto_Semilla + ".png"))
                            {
                                Imagen_320.Save(Ruta_Mapas_Jupisoft + "\\" + Texto_Semilla + ".png", ImageFormat.Png);
                            }
                            Imagen_320.Dispose();
                            Imagen_320 = null;
                            Texto_Semilla = null;
                ...
                if (Actualizar_Semillas_Parecidas) PixARK_Seeds.Buscar_Semillas_Parecidas(); // Update the seeds list.
            }
            catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; }
            finally
            {
        ...
        private void Menú_Contextual_Mostrar_Lista_Semillas_Parecidas_Click(object sender, EventArgs e)
        {
            try
            {
                this.Cursor = Cursors.WaitCursor;
                // And now for everybody, show the similar seeds list, based on their last 8 bits.
                if (Variable_Pantalla_Completa) Cursor.Show();
                Temporizador_Principal.Stop();
                Ventana_Semillas_Parecidas Ventana = new Ventana_Semillas_Parecidas();
                Ventana_Semillas_Parecidas.Variable_Semilla = Semilla;
                Ventana.Variable_Siempre_Visible = Variable_Siempre_Visible;
                Ventana.ShowDialog(this);
                Ventana.Dispose();
                Ventana = null;
            ...
            try
            {
                ...
                if (Imagen_Biomas_Original != null && Imagen_Biomas_Original_Simple != null && Imagen_Picture != null)
                {
                    ...
                    if (X > -1 && X < Ancho && Y > -1 && Y < Alto)
                    {
                        ...
                        string Texto_Bioma = "?";
                        for (int Índice_Bioma = 0; Índice_Bioma < PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo].Length; Índice_Bioma++)
                        {
                            if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color.R == Color_ARGB.R &&
                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color.G == Color_ARGB.G &&
                                PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color.B == Color_ARGB.B)
                            {
                                Texto_Bioma = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Índice.ToString() + ", " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Nombre + " (" + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Dificultad.ToString() + ")" + (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Minerales != PixARK.Minerales.Unknown ? " (" + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Minerales.ToString().Replace('_', ' ') + ")" : null);
                                break;
                            }
                        }
                    ...
                    if (Imagen_Biomas_Original != null && Imagen_Biomas_Original_Simple != null && Imagen_Picture != null)
                    {
                        ...
                        if (X > -1 && X < Ancho && Y > -1 && Y < Alto)
                        {
                            ...
                            for (int Índice_Bioma = 0; Índice_Bioma < PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo].Length; Índice_Bioma++)
                            {
                                ...
                                {
                                    if (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color_Simple.R == Color_ARGB.R &&
                                        PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color_Simple.G == Color_ARGB.G &&
                                        PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Color_Simple.B == Color_ARGB.B)
                                    {
                                        Texto_Bioma = PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Índice.ToString() + ", " + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Nombre + " (" + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Dificultad.ToString() + ")" + (PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Minerales != PixARK.Minerales.Unknown ? " (" + PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo][Índice_Bioma].Minerales.ToString().Replace('_', ' ') + ")" : null);
                                        Color_ARGB_Bioma = Color_ARGB;
                                        Establecer_Imagen_Picture(Variable_Mostrar_Mapa == 0 ? (Variable_Mostrar_Minerales ? Imagen_Biomas_Original : Imagen_Biomas_Original_Simple) : (Variable_Mostrar_Mapa == 1 ? Imagen_Altura_Original : Imagen_Arco_Iris_Original), Color_ARGB_Bioma);
            ...
            try
            {
                if (e.Button != MouseButtons.Right)
                {
                    ...
                    if (Control != null)
                    {
                        ...
                        try
                        {
                            Índice_Bioma = int.Parse(Control.Name.Replace("Picture_Leyenda_", null).Replace("Etiqueta_Leyenda_", null).Replace("Picture_SkyARK_Leyenda_", null).Replace("Etiqueta_SkyARK_Leyenda_", null));
                        }
                        ...
                        if (Índice_Bioma > -1)
                        {
                            foreach (PixARK.Biomas Bioma in PixARK.Biomas.Matriz_Biomas_PixARK_SkyARK[Tipo_Mundo])
                            {
                                if (Bioma.Orden == Índice_Bioma)
                                {
                                    Color_ARGB_Bioma = Variable_Mostrar_Minerales ? Bioma.Color : Bioma.Color_Simple;
                                    break;
                                }
                            }
                        }
        ...
        private void Menú_Contextual_Generar_Mapas_Superficie_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                Variable_Generar_Mapas_Superficie = Menú_Contextual_Generar_Mapas_Superficie.Checked;
            }
            catch (Exception Excepción) { Depurador.Escribir_Excepción(Excepción != null ? Excepción.ToString() : null); Variable_Excepción_Total++; Variable_Excepción = true; }
        }

        internal void Calcular_Diferencias_Altura_Ruinas()
        {
            try
            {
                // Array with the known surface ruin types.
                string[] Matriz_Rutas_Ruinas = new string[5]
                {
                    Application.StartupPath + "\\Ruins\\Pyramid Ruin",
                    Application.StartupPath + "\\Ruins\\Death Lord Platform",
                    Application.StartupPath + "\\Ruins\\Ice Ruin",
                    Application.StartupPath + "\\Ruins\\Broken Ruin",
                    Application.StartupPath + "\\Ruins\\Relic Ruin"
                };
                string Texto_Ruina = null;
                foreach (string Ruta_Ruina in Matriz_Rutas_Ruinas)
                {
                    string[] Matriz_Rutas = Directory.GetFiles(Ruta_Ruina, "*", SearchOption.TopDirectoryOnly);
                    if (Matriz_Rutas != null && Matriz_Rutas.Length > 0)
                    {
                        List<byte>[][] Matriz_Listas_Bytes = null;
                        int Ancho = 0;
                        int Alto = 0;
                        // Load each image and calculate it's height differences.
                        foreach (string Ruta in Matriz_Rutas)
                        {
                            Bitmap Imagen = Program.Cargar_Imagen_Ruta(Ruta, CheckState.Indeterminate);
                            if (Imagen != null)
                            {
                                /*int[,] Matriz_Ruina_ = new int[3, 2]
                                {
                                    { 0, 0 },
                                    { 0, 0 },
                                    { 0, 0 }
                                ...
                                Ancho = Imagen.Width;
                                Alto = Imagen.Height;
                                if (Matriz_Listas_Bytes == null)
                                {
                                    Matriz_Listas_Bytes = new List<byte>[Ancho][];
                                    for (int Índice_X = 0; Índice_X < Ancho; Índice_X++)
                                    {
                                        Matriz_Listas_Bytes[Índice_X] = new List<byte>[Alto];
                                        for (int Índice_Y = 0; Índice_Y < Alto; Índice_Y++)
                                        {
                                            Matriz_Listas_Bytes[Índice_X][Índice_Y] = new List<byte>();
                                        }
                                    }
                                }
                                ...
                                Bitmap_Data = null;
                                byte Mínimo = byte.MaxValue;
                                // Find the lowest surface in this structure.
                                for (int Índice_Y = 0, Índice = 0; Índice_Y < Alto; Índice_Y++, Índice += Bytes_Diferencia)
                                {
                                    ...
                                    {
                                        if (Matriz_Bytes_ARGB[Índice] < Mínimo) Mínimo = Matriz_Bytes_ARGB[Índice];
                                    }
                                }
                                // Add the each surface height, but changing the lowest to zero.
                                for (int Índice_Y = 0, Índice = 0; Índice_Y < Alto; Índice_Y++, Índice += Bytes_Diferencia)
                                {
                                    for (int Índice_X = 0; Índice_X < Ancho; Índice_X++, Índice += Bytes_Aumento)
                                    {
                                        Matriz_Listas_Bytes[Índice_X][Índice_Y].Add((byte)(Matriz_Bytes_ARGB[Índice] - Mínimo));
                                    }
                                }
                                Matriz_Bytes_ARGB = null;
                            }
                        }
                        Texto_Ruina += "internal static readonly byte[,] Matriz_Alturas_" + Path.GetFileName(Ruta_Ruina).Replace(' ', '_') + " = new byte[" + Alto + ", " + Ancho + "]\r\n{\r\n";
                        if (Matriz_Listas_Bytes != null)
                        {
                            byte[,] Matriz_Bytes_Ruina = new byte[Ancho, Alto];
                            for (int Índice_X = 0; Índice_X < Ancho; Índice_X++)
                            {
                                for (int Índice_Y = 0; Índice_Y < Alto; Índice_Y++)
                                {
                                    if (Matriz_Listas_Bytes[Índice_X][Índice_Y].Count > 0)
                                    {
                                        Dictionary<byte, int> Diccionario_Moda = new Dictionary<byte, int>();
                                        foreach (byte Valor in Matriz_Listas_Bytes[Índice_X][Índice_Y])
                                        {
                                            if (!Diccionario_Moda.ContainsKey(Valor))
                                            {
                                                Diccionario_Moda.Add(Valor, 1);
                                            }
                                            else Diccionario_Moda[Valor]++;
                                        }
                                        int Máximo = int.MinValue;
                                        byte Moda = byte.MinValue;
                                        foreach (KeyValuePair<byte, int> Entrada in Diccionario_Moda)
                                        {
                                            if (Entrada.Value > Máximo)
                                            {
                                                Máximo = Entrada.Value;
                                                Moda = Entrada.Key;
                                            }
                                        }
                                        Matriz_Bytes_Ruina[Índice_X, Índice_Y] = Moda;
                                    }
                                }
                            }
                            for (int Índice_Y = 0; Índice_Y < Alto; Índice_Y++)
                            {
                                ...
                                for (int Índice_X = 0; Índice_X < Ancho; Índice_X++)
                                {
                                    Texto_Ruina += Matriz_Bytes_Ruina[Índice_X, Índice_Y].ToString() + (Índice_X < Ancho - 1 ? ", " : " },\r\n");
                                }
                            }
                            Texto_Ruina += "};\r\n";
                        }
